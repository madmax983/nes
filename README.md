...
> **⚠️ REQUIRES FEATURE NOVA:** To use experimental features like the `story_demo` or `NarrativeGenerator`, you must enable the `nova` feature flag during build (e.g., `cargo run --features nova`).
