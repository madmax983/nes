...
api_content = re.sub(r'self\.ports\.controller_port_sample\(Player::One, CONTROLLER_OPEN_BUS_MASK\)', 'self.ports.controller_port_sample(Player::One)', api_content)
api_content = re.sub(r'self\.ports\.controller_port_sample\(Player::Two, CONTROLLER_OPEN_BUS_MASK\)', 'self.ports.controller_port_sample(Player::Two)', api_content)
