...
/// The default bind address for the MCP host.
pub const DEFAULT_MCP_BIND_ADDR: &str = "127.0.0.1:6502";
/// CLI Usage string for help output.
...
pub struct RuntimeArgs {
    ...
    /// Initial cheat codes to enable.
    pub cheat_codes: Vec<String>,
    /// Whether to enable the MCP host.
    pub mcp_enabled: bool,
    /// Address to bind the MCP host to.
    pub mcp_bind_addr: String,
    /// Whether to enable netplay.
    pub netplay_enabled: bool,
    /// Netplay relay server address.
