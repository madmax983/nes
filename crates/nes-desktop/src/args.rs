...
/// Default bind address for the MCP host.
pub const DEFAULT_MCP_BIND_ADDR: &str = "127.0.0.1:6502";
/// Usage string for the desktop runtime.
...
/// Parsed command-line arguments for the desktop runtime.
pub struct RuntimeArgs {
    /// Optional ROM path to load.
    pub rom_path: Option<String>,
    /// Active cheat codes.
    pub cheat_codes: Vec<String>,
    /// Whether the MCP host is enabled.
    pub mcp_enabled: bool,
    /// The address to bind the MCP host to.
    pub mcp_bind_addr: String,
    /// Whether netplay is enabled.
    pub netplay_enabled: bool,
    /// The relay server address for netplay.
    pub netplay_relay_addr: Option<String>,
    /// The netplay room to join.
    pub netplay_room: Option<String>,
    /// The netplay player ID (0 for auto).
    pub netplay_player: Option<u8>,
    /// Netplay input delay frames.
    pub netplay_input_delay_frames: Option<u32>,
    /// Netplay maximum rollback frames.
    pub netplay_max_rollback_frames: Option<u32>,
    /// Netplay frequency of state hash checks.
    pub netplay_hash_check_every_frames: Option<u64>,
    /// Whether RTA mode is enabled.
    pub rta_enabled: bool,
    /// RTA profile ID to use.
    pub rta_profile_id: Option<String>,
    /// Directory containing RTA profiles.
    pub rta_profiles_dir: Option<String>,
    /// Directory to store RTA run reports.
    pub rta_runs_dir: Option<String>,
    /// Run RTA in calibration mode.
    pub rta_calibrate: bool,
    #[cfg(feature = "nova")]
    /// Whether the experimental auto player is enabled.
