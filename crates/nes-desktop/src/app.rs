...
/// A mapped command targeting the emulator core.
pub struct BridgeCommand {
    /// The underlying core command.
    pub core: Command,
}

impl BridgeCommand {
    #[must_use]
    /// Returns the name of the tool this command is associated with.
...
#[must_use]
/// Maps a raw desktop key event string to an executable emulator command.
...
#[must_use]
/// Maps a raw desktop key event string to a standard NES controller button.
...
#[must_use]
/// Maps a raw desktop key event string to a standard NES controller button.
/// Maps a raw desktop key event string to its internal bitmask equivalent.
