...
/// A command generated by user input mapping.
...
impl BridgeCommand {
    #[must_use]
    /// Returns the MCP tool name associated with this command.
...
#[must_use]
/// Maps a web/winit key code to a bridge command.
...
#[must_use]
/// Maps a key code to a controller button.
...
#[must_use]
/// Maps a key code to a controller button bit.
