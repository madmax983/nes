...
/// A command sent to the core emulator from the desktop UI.
pub struct BridgeCommand {
    /// The core emulation command.
    pub core: Command,
}

impl BridgeCommand {
    #[must_use]
    /// Returns a string identifier for the tool/command.
...
#[must_use]
/// Maps a keyboard event to an emulator command.
...
#[must_use]
/// Maps a keyboard event to a controller button.
...
#[must_use]
/// Maps a keyboard event to a controller button bitmask.
