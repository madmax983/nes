...
pub(crate) const DEFAULT_CPU_STEPS_PER_FRAME: u32 = 10_000;
pub(crate) const DEFAULT_WINDOW_SCALE: u32 = 3;
pub(crate) const DEFAULT_TRACE_EVERY_FRAMES: u64 = 0;
pub(crate) const DEFAULT_CAPTURE_EVERY_FRAMES: u64 = 1;
...
pub(crate) fn recommended_input_delay_frames(
    rtt_ms: Option<f64>,
    jitter_ms: f64,
