...
fn handle_toggle_cheat(index: usize, ctx: &mut AppContext<'_>) {
...
fn handle_remove_cheat(index: usize, ctx: &mut AppContext<'_>) {
...
fn handle_submit_cheat_code(raw_code: String, ctx: &mut AppContext<'_>) {
