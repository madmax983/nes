...
use nes_netplay::{ClientMessage, NetplayRuntimeStats, ServerMessage};
...
mod tests {
    ...
    use crate::netplay::{
        compute_local_netplay_bits, handle_netplay_server_message, schedule_netplay_ping,
        should_send_netplay_hash,
    };
