...
/// **⚡ Bolt Optimization:** By taking a `&mut String` buffer parameter, this function reuses
/// the caller's heap capacity (`line.clear()`) rather than creating and destroying a new `String`
/// per incoming high-frequency packet.
