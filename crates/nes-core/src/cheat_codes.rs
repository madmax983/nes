...
mod tests {
    ...
    fn cheat_code_decodes_value_bits_with_alternating_bits() {
        ...
        assert_eq!(code_alt.address(), 50741);
        assert_eq!(code_alt.value(), 33);
        assert_eq!(code_alt.compare(), Some(7));
    }
}
