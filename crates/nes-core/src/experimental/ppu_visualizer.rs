...
/// A utility for visualizing the NES Picture Processing Unit (PPU) internal state.
///
/// Provides methods to extract pattern tables and nametables as BMP image bytes.
