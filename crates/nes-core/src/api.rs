...
use crate::mapper::{Axrom, Camerica, Cnrom, ColorDreams, Fme7, Gxrom, LoadedMapper, MapperDelta, MapperDeltaKind, Mmc1, Mmc2, Mmc3, Mmc4, Mmc5, Namco108, Nrom, Uxrom};
...
pub(crate) const CHR_8K_BYTES: usize = 8 * 1024;
