...
/// Returns the absolute path to the default `homebrew.nes` ROM used across integration tests.
///
/// This path is resolved relative to the cargo manifest directory of the `nes-test-harness` crate,
/// pointing to the workspace's `roms/homebrew/homebrew.nes` file.
///
/// ## Examples
///
/// ```rust
