...
/// Returns the absolute path where the default homebrew ROM should be located within the workspace.
///
/// This path usually resolves to `<workspace_root>/roms/homebrew/homebrew.nes`.
///
/// ## Examples
///
/// ```
