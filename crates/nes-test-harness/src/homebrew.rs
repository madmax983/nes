...
/// Returns the default path where the generated homebrew test ROM should be saved.
///
/// This resolves to `roms/homebrew/homebrew.nes` relative to the workspace root.
///
/// ## Examples
///
/// ```rust
