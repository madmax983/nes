...
#[allow(dead_code)]
/// Returns the configured path to the Super Mario Bros ROM.
...
#[allow(dead_code)]
/// Returns the configured path to the nestest ROM.
...
#[allow(dead_code)]
/// Returns the configured path to the Blargg CPU test ROM.
...
#[allow(dead_code)]
/// Returns a list of paths to the `.nes` ROMs in the bbbradsmith audio suite directory.
...
#[allow(dead_code)]
/// Returns the configured path to the directory containing golden reference PCM audio for the bbbradsmith suite.
