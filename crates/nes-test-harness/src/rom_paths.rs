...
#[allow(dead_code)]
/// Gets the configured path for the SMB ROM.
...
#[allow(dead_code)]
/// Gets the configured path for the nestest ROM.
...
#[allow(dead_code)]
/// Gets the configured path for the blargg CPU test ROM.
...
#[allow(dead_code)]
/// Gets the paths to all ROMs in the configured bbbradsmith audio suite directory.
...
#[allow(dead_code)]
/// Gets the configured path to the directory containing bbbradsmith audio golden captures.
