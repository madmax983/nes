...
#[allow(dead_code)]
/// Retrieves the path to the configured Super Mario Bros. ROM for integration testing.
...
#[allow(dead_code)]
/// Retrieves the path to the configured `nestest` ROM for CPU instruction tests.
...
#[allow(dead_code)]
/// Retrieves a list of all test ROM paths within the configured Brad Smith audio test suite directory.
...
#[allow(dead_code)]
/// Retrieves the path to the directory containing golden audio waveform artifacts.
