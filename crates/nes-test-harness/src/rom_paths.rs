...
#[allow(dead_code)]
/// Returns the path to the blargg CPU test ROM.
...
#[allow(dead_code)]
/// Returns the paths to the bbbradsmith audio test ROMs.
...
#[allow(dead_code)]
/// Returns the path to the bbbradsmith audio golden output directory.
