...
#[cfg(feature = "nova")]
const TOOL_CATALOG: [ToolDefinition; 32] = [
    ToolDefinition {
        name: "get_ppu_oam",
        description: "Get the current PPU OAM (Object Attribute Memory) data representing 64 sprites",
    },
    ...
    ToolDefinition {
        name: "load_state",
        description: "Deserialize emulator state",
    },
    ToolDefinition {
        name: "run_macro",
        description: "Execute a macro sequence",
    },
    ToolDefinition {
        name: "assemble_6502_dsl",
        description: "Assemble a 6502 DSL module to standard output blocks",
    },
    ToolDefinition {
        name: "load_6502_dsl",
        description: "Assemble and load a 6502 DSL module into the live emulator core",
    },
    ToolDefinition {
        name: "export_6502_dsl_rom",
        description: "Assemble a 6502 DSL module and write an iNES ROM to disk",
    },
    ToolDefinition {
        name: "export_6502_dsl_rom_base64",
        description: "Assemble a 6502 DSL module directly to a Base64-encoded iNES payload",
    },
    ToolDefinition {
        name: "extract_sprite_sheet",
        description: "Extract the CHR RAM sprites as a BMP image",
    },
];
