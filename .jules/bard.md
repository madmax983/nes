...
## 2025-07-02 - Adding Doc Tests to Missing Experimental Tools
**Confusion:** Some of the newer experimental tools (`ZoneTracker`, `ExecutionGraph`, `PpuVisualizer`, and `MemoryHeatmap`) lacked executable examples in their public API documentation, making it difficult for users to understand how to correctly instantiate and utilize them without reading the source code or test modules.
**Clarification:** Added thorough `///` comments containing `## Examples` sections to all public methods in these modules (`ZoneTracker::new`, `ZoneTracker::add_zone`, `ZoneTracker::track`, `ZoneTracker::events`, `ExecutionGraph::new`, `ExecutionGraph::record_step`, `ExecutionGraph::to_dot`, `PpuVisualizer::extract_pattern_table_bmp`, `PpuVisualizer::extract_nametables_with_scroll_bmp`, `MemoryHeatmap::new`, `MemoryHeatmap::record_trace`, `MemoryHeatmap::decay_frame`, and `MemoryHeatmap::render_bmp`), providing executable context and demonstrating valid usage.
