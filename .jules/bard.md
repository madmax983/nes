...
## 2024-05-15 - Documentation link to private item
**Confusion:** Using `[`DOTS_PER_CPU_CYCLE`]` intra-doc link for a private constant fails `cargo doc` warnings.
**Clarification:** Use standard markdown inline code backticks `` `DOTS_PER_CPU_CYCLE` `` instead for private items.
