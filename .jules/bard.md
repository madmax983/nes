...
## 2024-05-24 - Test Harness Documentation Gaps
**Confusion:** The integration testing utilities, like waveform comparisons and APU event capturing, lacked public API documentation, making it difficult for developers to understand the required input structures and outputs.
**Clarification:** I added comprehensive doc-comments to `ApuWriteEvent`, `AudioStats`, `WaveformComparison`, and various helper functions, including concrete, executable doctests for each to demonstrate correct usage and clarify field semantics.
