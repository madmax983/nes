...
## 2024-08-18 - Private Item Intra-doc Links
**Confusion:** Using intra-doc links to point to private constants or items (e.g., `[`DOTS_PER_CPU_CYCLE`]`) causes `rustdoc` warnings: `public documentation links to private item`.
**Clarification:** Use standard inline code blocks (e.g., `` `DOTS_PER_CPU_CYCLE` ``) instead of intra-doc links when referencing private items to avoid warnings.
