...
## 2025-07-31 - README config setup instructions
**Confusion:** The README instructed users to run the emulator with `nes.toml`, but this file doesn't exist by default. Users got a `No such file or directory` error.
**Clarification:** Added a step to the README instructing users to copy the example configuration file (`cp nes.example.toml nes.toml`) before running the emulator.
